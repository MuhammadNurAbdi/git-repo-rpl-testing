...
browser.find_element_by_id('nim_mhs').send_keys("ABDI")
browser.find_element_by_id('almt_mhs').send_keys("Banjarbaru 156")
browser.find_element_by_id('no_mhs').send_keys("$$$$$$$$$")
browser.find_element_by_id('email_mhs').send_keys("Abdi")
